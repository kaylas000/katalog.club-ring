      ...
      <section className="py-10 lg:py-14">
        <div className="max-w-4xl mx-auto px-5">
          <div className="prose-custom max-w-none space-y-6 text-text-secondary leading-relaxed">
            <p><strong className="text-text-primary">Club-Ring</strong> — это крупнейший каталог боксёрских залов {cityLabel || "России"}. Мы собираем информацию о залах, тренерах и секциях бокса по всей стране.</p>
